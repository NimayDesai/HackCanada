    ...
    <div className="w-[106%] -ml-9 min-h-screen mt-6 flex flex-col items-center relative overflow-hidden bg-gradient-to-b from-lime-100 to-white dark:from-gray-900 dark:to-gray-800">
      ...
      <div className="rounded-[2rem] px-16 pb-20 pt-16 text-center">
        ...
        <div className="mt-10 flex gap-6 justify-center">
          <Button
            className="rounded-full bg-lime-600 px-8 py-4 text-lg font-semibold text-white shadow-lg hover:bg-lime-700 transition duration-300"
            onClick={() => (window.location.href = "/login")}
          >
            Get Started
          </Button>
          <Button
            className="rounded-full border-2 border-gray-900 dark:border-gray-100 px-8 py-4 text-lg font-semibold text-white dark:text-gray-800 hover:bg-gray-700 hover:text-white dark:hover:bg-gray-100 dark:hover:text-gray-900 transition duration-300"
      ...
      <h1
        ref={whyNutriMindRef}
        className="mt-24 text-4xl font-bold text-gray-900 dark:text-gray-100 text-center"
      >
      ...
      <div className="relative px-5 py-16 w-full max-w-7xl">
        <div className="rounded-[2rem] bg-lime-200 dark:bg-gray-800 px-12 pb-16 pt-12 shadow-xl grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          <FeatureCard
      ...
      <div className="mt-24 text-center pb-20">
        ...
        <Button
          className="mt-6 rounded-full bg-lime-600 px-8 py-4 text-lg font-semibold text-white shadow-lg hover:bg-lime-700 transition duration-300"
          onClick={() => (window.location.href = "/login")}
        >
          Get Started
        </Button>
